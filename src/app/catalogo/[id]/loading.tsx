...
export default function GameDetailLoading() {
  return (
    <div
      className="bg-bg text-fg min-h-screen flex flex-col font-display overflow-x-hidden selection:bg-selection selection:text-selection-fg relative"
      role="status"
      aria-live="polite"
      aria-busy="true"
    >
        ...
        <div className="w-full max-w-[1280px] flex flex-col gap-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-5 flex flex-col gap-4 animate-pulse">
              <div className="relative w-full aspect-square rounded-lg border-2 border-primary/20 bg-panel overflow-hidden">
                ...
                <div className="absolute inset-2 bg-bg" />
              </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 animate-pulse">
              ...
              <div className="flex flex-col gap-2 p-6 rounded-lg border border-dashed border-primary/30 bg-panel/70">
                <SkeletonLine className="h-4 w-48" />
                <SkeletonLine className="h-4 w-full" />
                <SkeletonLine className="h-4 w-5/6" />
                <SkeletonLine className="h-4 w-2/3" />
              </div>
              <SkeletonLine className="h-12 w-full max-w-[520px]" />
