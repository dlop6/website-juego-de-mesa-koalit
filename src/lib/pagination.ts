// centraliza helpers de paginación
const DEFAULT_PAGE = 1;

// intenta convertir un string a número, devuelve null si no fue válido
...
// parsea el parámetro page aplicando fallback y clamp mínimo
...
// calcula el total de páginas protegiendo contra valores inválidos
...
// garantiza que la página estuviera dentro del rango total
