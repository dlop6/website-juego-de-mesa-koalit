...
// define las props del loading state
export interface LoadingStateProps extends HTMLAttributes<HTMLDivElement> {
  count?: number;
  label?: string;
}

// representa una tarjeta skeleton simple usada para placeholder en listas
...
// renderiza un estado de carga con n skeletons y una etiqueta opcional
